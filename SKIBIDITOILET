...
local Button = MainTab:CreateButton({
   Name = "Killaura",
   Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Chungdz09/Script-chung-dz/refs/heads/main/boogabooga.lua"))()  
  end,
})
...
local Section = Tab4:CreateSection("Chest") 

local Button = Tab4:CreateButton({
    Name = "Open Chest",
    Callback = function()
        local Events['InventoryInteraction']:FireServer(168, "Open")
    end
})
