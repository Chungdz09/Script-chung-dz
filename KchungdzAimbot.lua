...
function FindNearestPlayer()
	...
	for _, v in pairs(Players:GetPlayers()) do
		if v ~= LocalPlayer and v.Character and v.Character:FindFirstChild("Humanoid") and v.Character:FindFirstChild("Humanoid").Health > 0 and v.Character:FindFirstChild(_G.AimPart) then
	...
	if Input.UserInputType == Enum.UserInputType.MouseButton2 then
		...
		if Active then
			...
			while HoldingM2 do task.wait(.000001)
				if Lock and The_Enemy ~= nil and The_Enemy:FindFirstChild(_G.AimPart) then
